...
## MIPS란 무엇일까?
MIPS(Microprocessor without Interlocked Pipeline Stages)란 MIPS Technologies에서 개발한 RISC 기반의 명령어 집합 체계이다. MIPS 명령어 체계는 굉장히 깔끔하게 설계되어있기때문에 많은 대학교의 컴퓨터 아키텍처 강좌과목에서 가르치고 있다. by 나무위키 (출처 : https://namu.wiki/w/MIPS)
...
>![사진1](/uploads/93642840c9758ee3e6fc0f5c4bd1f930/사진1.png)
...
>![사진2](/uploads/a445b0242777a43458a3fa12604f38df/사진2.png)
...
>![사진3](/uploads/cf78b12080d517537f535694490729fe/사진3.png)

간단한 Hello World 코드를 짜고 컴파일해서 IDA로 열어보면,

>![사진4](/uploads/4d845715274bfa02f208a40f983b58fa/사진4.png)

짜잔!!! 이게 MIPS에요 여러분 ㅎㅎ (개봉 시, 32bit로
우선 왼쪽 명령어 주소들이 4바이트 단위로 떨어지는 것으로 보아 MIPS는 RISC 구조인 것을 알 수 있어요!!

---

>![사진5](/uploads/ed5f48bb70842defb439d44028e9e5fd/사진5.png)
...
네 번째 라인에서 **move $fp, $sp**를 보면, fp에 sp의 주소를 넣는다는 의미! 즉, mov ebp, esp와 같은
 의미를 담은 명령어 입니다.

---

>![사진6](/uploads/106edd9ca14097974eac024207dc44a8/사진6.png)
...
---
>![사진7](/uploads/95ce1c3c5898fb55fcedeb5b620fd195/사진7.png)
